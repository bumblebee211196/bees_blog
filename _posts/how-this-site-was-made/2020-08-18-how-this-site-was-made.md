...
date: 2020-08-18 09:45:47 +05:30
tags: [blog, netlify, jekyll, github]
description: All the services are free, a source code this site placed on github repository and integration with netlify service, another service you can use is github page for hosting your own static site.
---

The website was made using Jekyll the one of open source static site generator, and using the theme [klisé](https://github.com/piharpi/klise).
